  ...
  const blogPosts = [
    {
      ...
      body: "<p>Certainly! Learning web development can be an exciting journey. Here's a step-by-step guide to help you get started with web Understand the Basics HTML (HyperText Markup Language)Learn the fundamentals of HTML, which is the markup language used to structure content on the web.
    ...
    {
      title: "HTML 5",
      body:"<p>Absolutely! HTML (HyperText Markup Language) is the foundation of web development, and it's essential to understand its basics. Here's a beginner's guide to learning HTML:
...
8. HTML Entities: Understand HTML entities for special characters, such as &lt; for < and &gt; for >. 10. Practice: Apply your knowledge by creating simple web pages. Practice is crucial for reinforcing what you've learned.</p>",
    ...
    {
      title: "Sass",
      body:"<p>Certainly! SASS (Syntactically Awesome Stylesheets) is a popular CSS preprocessor that adds features and syntax enhancements to make styling websites more efficient and maintainable. Here's a beginner's guide to learning SASS:
