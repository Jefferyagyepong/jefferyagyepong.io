...
export default function Work() {
    ...
    <section className="flex-box ">
      <div className="flex-item" id="CoastRepublic">
        <Image  className="hide-image" src="static/coastvibezvintage2.svg"  alt="Coast Republic"width={380} height={400} />     
     <div className="hide">
...
launch on 08-04-23              
     ...
     <Image  className="hide-image" src="static/Beelydrop.svg"  alt="Beelydrop"width={380} height={400} />   
            <div className="hide">
            <span>
